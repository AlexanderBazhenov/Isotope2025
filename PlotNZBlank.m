...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pB = pcolor(XN,YN,+1*BetaIndNZ(Nmin:Nmax, Zmin:Zmax)')
set(pB, 'linewidth', 0.5)
set(pB, 'edgecolor', [1 1 1])
pE = pcolor(XN,YN,+1*ECIndNZ(Nmin:Nmax, Zmin:Zmax)')
set(pE, 'linewidth', 0.5)
set(pE, 'edgecolor', [1 1 1])
pA = pcolor(XN,YN,+AlphaIndNZ(Nmin:Nmax, Zmin:Zmax)')
set(pA, 'linewidth', 0.5)
set(pA, 'edgecolor', [1 1 1])
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
titlestr = strcat("Стабильные и нестабильные элементы. N-Z")
ht = title(titlestr)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
filestr = strcat("Stable","NZ","Magic")
